...
A app store rating dialog implementation demo, Developed using SwiftUI.
...
1. Clone the repo
   ```sh
   git clone https://github.com/Mobile-Apps-Academy/AppStoreRatingSwiftUI.git
   ```
### Usage

1. How to trigger the rating dialog
